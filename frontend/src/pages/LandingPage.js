...
Чем могу помочь?`
  ...
  const processSteps = [
    { num: "01", title: "Создание запроса", desc: "Опишите автомобиль мечты в заявке или выберите из каталога Che168. AI-ассистент поможет определить оптимальные параметры и рассчитать бюджет под ключ в Беларуси.", icon: Search },
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: "Комиссия платформы составляет 3% от стоимости автомобиля (FOB Китай). При проведении платежа через платформу взимается дополнительно 1.5%, которые включают банковские издержки и гарантию безопасности. Это единственные расходы — никаких скрытых наценок."
    },
    {
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="fade-in">
              ...
              <p className="text-lg text-slate-400 mb-8 max-w-lg">
                CarBridge — мост доверия между покупателем и автомобилем. Прозрачная цифровая платформа с тендером среди проверенных дилеров, AI-подбором и контролем каждого этапа.
              </p>
