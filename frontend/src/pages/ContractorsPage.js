                ...
                <Dialog open={isAddDialogOpen} onOpenChange={(open) => { setIsAddDialogOpen(open); if (!open) resetForm(); }}>
                  ...
                  <DialogContent className="bg-[#15191E] border-[#27272A] text-white max-w-lg max-h-[90vh] overflow-y-auto">
                    ...
                    <div className="space-y-4 mt-4">
                      <div>
                        <Label className="text-slate-300">Тип подрядчика *</Label>
                        <div className="grid grid-cols-3 gap-2 mt-2">
                          {Object.entries(contractorTypes).map(([key, { label, icon: Icon }]) => (
                            <button
                              key={key}
                              type="button"
                              onClick={() => setFormData(prev => ({ ...prev, contractor_type: key }))}
                              className={`py-2 px-3 rounded-sm border text-sm flex items-center justify-center gap-2 ${
                      ...
                      <div>
                        <Label className="text-slate-300">Услуги *</Label>
                        <textarea
                          name="services"
                          value={formData.services}
                          onChange={handleChange}
                          placeholder="Перечень услуг..."
                          className="mt-1 w-full bg-[#0B0F14] border border-[#27272A] rounded-sm px-3 py-2 text-white placeholder:text-slate-500 min-h-[60px]"
                        />
                      </div>

                      <div>
                        <Label className="text-slate-300">Диапазон цен</Label>
                        <Input
                          name="price_range"
                      ...
                      <div>
                        <Label className="text-slate-300">Сайт</Label>
                        <Input
                          name="website"
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <Label className="text-slate-300">Рейтинг (1-5)</Label>
                          <Input
                            name="rating"
                            type="number"
                            min="1"
                        ...
                        <div>
                          <Label className="text-slate-300">Кол-во сделок</Label>
                          <Input
                            name="deals_count"
                            type="number"
                            min="0"
                            value={formData.deals_count}
                            onChange={handleChange}
                            className="mt-1 bg-[#0B0F14] border-[#27272A]"
                          />
                        </div>
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          onChange={handleChange}
                          className="w-4 h-4 rounded border-[#27272A] bg-[#0B0F14]"
                        />
                        <Label className="text-slate-300">Верифицированный подрядчик</Label>
                      </div>
                      ...
                      >
                        {submitting ? 'Добавление...' : 'Добавить подрядчика'}
                      </Button>
                    </div>
                  </DialogContent>
                </Dialog>
